...
| kernel                 | 7.0.12-37.stable                                                                                                                                                |
| gcc                    | gcc (AerynOS) 16.1.1 20260505                                                                                                                                   |
| clang                  | clang version 22.1.7 (AerynOS)                                                                                                                                  |
| go                     | go version go1.26.4 linux/amd64                                                                                                                                 |
| rustc                  | rustc 1.98.0-nightly (bc2112ed5 2026-06-18)                                                                                                                     |
...
| --------------------- | -------- | ------- | ------- | -------- | ------------------------ |
| sarif (stage0/native) | sarifc   | native  | dynamic | yes      | 10.84                    |
...
| --------------------- | ---------- | ------------ | ------------ | ---------- | ---------- |
| sarif (stage0/native) | 11         | 989          | 35288        | 1.0000     | 1.0000     |
...
| ------------ | --------------------- | -------------------------------- | ------------------------------------------------------------------------ | -------------- | ------------ | ----------------- | ----------------- | ------ |
| binarytrees  | sarif (stage0/native) | 20                               | stretch tree of depth 21	 check: 4194303 / 1048576	 trees of depth 4	... | 0.0678         | 20.8807      | 6144.73           | 10.84             | ok     |
| csvgroupby   | sarif (stage0/native) | fixture:orders-120000.csv        | sha256:b7ce6bd0a0cc01ea                                                  | 0.0953         | 0.0259       | 36.59             | 14.62             | ok     |
| fasta        | sarif (stage0/native) | 250000                           | sha256:dfd37a44ede2e23f                                                  | 0.0685         | 0.0479       | 36.59             | 11.16             | ok     |
| joinagg      | sarif (stage0/native) | fixture:users-events-180000.txt  | sha256:37c7ac2d5630fe43                                                  | 0.0552         | 0.0802       | 36.59             | 18.72             | ok     |
| knucleotide  | sarif (stage0/native) | fixture:knucleotide-250000.fasta | A 30.328 / T 30.079 / C 19.799 / G 19.794 /  / AA 9.188 / TA 9.122 / ... | 0.0621         | 0.0085       | 37.51             | 15.12             | ok     |
| mandelbrot   | sarif (stage0/native) | 512                              | sha256:e41a9386e912a316                                                  | 0.0849         | 0.0304       | 37.51             | 7.86              | ok     |
| nbody        | sarif (stage0/native) | 5000000                          | -0.169075164 / -0.169083134                                              | 0.0641         | 0.4633       | 37.51             | 17.11             | ok     |
| primecount   | sarif (stage0/native) | 50000                            | 5133                                                                     | 0.0584         | 0.0046       | 37.51             | 8.36              | ok     |
| revcomp      | sarif (stage0/native) | fixture:knucleotide-250000.fasta | sha256:14899a73679b1d83                                                  | 0.0541         | 0.0077       | 37.51             | 10.34             | ok     |
| sortuniq     | sarif (stage0/native) | fixture:words-250000.txt         | sha256:6b28b0e803b80ff3                                                  | 0.0523         | 0.0273       | 37.51             | 13.58             | ok     |
| spectralnorm | sarif (stage0/native) | 5000                             | 1.274224153                                                              | 0.0847         | 2.0654       | 37.51             | 10.76             | ok     |
